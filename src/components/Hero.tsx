...
const T = {
  es: {
    ...
    desc1:        'Construyo experiencias digitales elegantes y eficientes desde interfaces pixel-perfect hasta sistemas backend robustos. Actualmente explorando la interseccion entre',
